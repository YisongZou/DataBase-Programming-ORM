# Generated by Django 3.0.2 on 2020-03-16 21:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ncaa_db.Color')),
                ('state_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ncaa_db.State')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('team_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ncaa_db.Team')),
            ],
        ),
    ]
